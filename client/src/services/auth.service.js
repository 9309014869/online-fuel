...
const updateDeliveryPerson = (orderId,deliveryPerson) =>{
  return axios
  .put(API_URL + `order/addDeliveryPerson`,{
    orderId,
    deliveryPerson
  })
  .then((response) => {
...
const displayRazorpay = async(totalDeliveryCharge,setTransactionData)=>{
    ...
    const { amount, id: order_id, currency } = result.data;
     console.log(amount)
    const options = {
        key: "rzp_test_4sjZAAo2056hlR", // Enter the Key ID generated from the Dashboard
        currency: currency,
        name: "Fuel Station",
        description: "",
        order_id: order_id,
