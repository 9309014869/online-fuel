...
import { acceptOrder,addDeliveryPerson, addOrder,getOrderByUserId, cancleOrder, deliveryOrder, getOrders,getOrderByFuelStationId} from "../controllers/orderController.js";
...
router.put('/addDeliveryPerson',addDeliveryPerson)
// router.route('/:id')
